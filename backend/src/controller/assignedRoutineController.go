...
// GetAssignedRoutinesByUserID Get AssignedRoutine by user id
func GetAssignedRoutinesByUserID(c *gin.Context) {
	...
	if len(*resultSet) == 0 {
		c.JSON(404, "Assigned routine not found for this user")
	} else {
